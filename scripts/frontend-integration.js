 ...
 * This file demonstrates how to integrate Surgestate with a web frontend
 */

// For React/Vue/Angular applications
export class SurgestateClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SurgestateClient(provider, contractAddress);
